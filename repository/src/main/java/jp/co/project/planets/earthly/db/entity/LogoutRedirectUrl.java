...
*/
@Entity(listener = LogoutRedirectUrlListener.class )
...
private static final long serialVersionUID = 1L;
     ...
     *         削除フラグ
     */
    public LogoutRedirectUrl(final String id,final String oauthClientId,final String redirectUrl,final LocalDateTime createdAt,final String createdBy,final LocalDateTime updatedAt,final String updatedBy,final Boolean isDeleted) {
        this.id = id;
