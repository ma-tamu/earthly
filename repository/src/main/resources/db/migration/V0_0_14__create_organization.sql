...
(
  `id`         char(32)    NOT NULL COMMENT 'グループID',
  `company_id` char(32)    NOT NULL COMMENT '会社ID',
  `name`       varchar(50) NOT NULL COMMENT 'グループ名',
  ...
  COLLATE = utf8mb4_bin COMMENT '組織';

CREATE INDEX idx_organization_company_id on organization(company_id);