...
public class OAuthClientConsentDaoTest {
    ...
    public void testSelectConsentClientIdByUserId(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/jp/co/project/planets/earthly/db/dao/OAuthClientConsentDao/selectConsentClientIdByUserId.sql", dialect);
        execute(sqlFile);
    }
