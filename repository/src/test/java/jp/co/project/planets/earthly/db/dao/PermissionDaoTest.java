...
public class PermissionDaoTest {
    ...
    public void testSelectGrantPermissionByUserId(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/jp/co/project/planets/earthly/db/dao/PermissionDao/selectGrantPermissionByUserId.sql", dialect);
        execute(sqlFile);
    }
