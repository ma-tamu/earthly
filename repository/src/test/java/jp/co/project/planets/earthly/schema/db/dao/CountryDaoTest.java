...
public class CountryDaoTest {
     ...
     */
    @Test
    public void testSelectAll(final TestInfo testInfo) throws Exception {
        final SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(),
                "META-INF/jp/co/project/planets/earthly/schema/db/dao/CountryDao/selectAll.sql", dialect);
        execute(sqlFile);
    }
