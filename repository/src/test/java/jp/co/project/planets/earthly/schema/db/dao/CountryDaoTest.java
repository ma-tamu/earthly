...
public class CountryDaoTest {
    ...
    public void testSelectAll(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/jp/co/project/planets/earthly/schema/db/dao/CountryDao/selectAll.sql", dialect);
        execute(sqlFile);
    }
