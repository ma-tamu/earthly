...
public class NoticeDaoTest {
     ...
     */
    @Test
    public void testSelectByTitleAndPublicationDate(final TestInfo testInfo) throws Exception {
        final SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(),
                "META-INF/jp/co/project/planets/earthly/schema/db/dao/NoticeDao/selectByTitleAndPublicationDate.sql",
                dialect);
        execute(sqlFile);
    }
