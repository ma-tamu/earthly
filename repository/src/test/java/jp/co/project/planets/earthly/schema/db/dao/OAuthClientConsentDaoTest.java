...
public class OAuthClientConsentDaoTest {
     ...
     */
    @Test
    public void testSelectConsentClientIdByUserId(final TestInfo testInfo) throws Exception {
        final SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(),
                "META-INF/jp/co/project/planets/earthly/schema/db/dao/OAuthClientConsentDao/selectConsentClientIdByUserId.sql",
                dialect);
        execute(sqlFile);
    }
