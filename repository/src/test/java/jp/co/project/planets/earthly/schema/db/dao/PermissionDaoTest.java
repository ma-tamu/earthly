...
public class PermissionDaoTest {
     ...
     */
    @Test
    public void testSelectGrantPermissionByUserId(final TestInfo testInfo) throws Exception {
        final SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(),
                "META-INF/jp/co/project/planets/earthly/schema/db/dao/PermissionDao/selectGrantPermissionByUserId.sql",
                dialect);
        execute(sqlFile);
    }
