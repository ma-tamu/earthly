...
public class ScopeDaoTest {
    ...
    public void testSelectByClientId(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/jp/co/project/planets/earthly/schema/db/dao/ScopeDao/selectByClientId.sql", dialect);
        execute(sqlFile);
    }
