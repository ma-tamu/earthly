...
public class UserRoleDaoTest {
     ...
     */
    @Test
    public void testSelectByUserIdAndRoleId(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/jp/co/project/planets/earthly/schema/db/dao/UserRoleDao/selectByUserIdAndRoleId.sql", dialect);
        execute(sqlFile);
    }
