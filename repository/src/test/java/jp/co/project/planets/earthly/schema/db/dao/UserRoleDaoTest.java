...
public class UserRoleDaoTest {
     ...
     */
    @Test
    public void testSelectByUserIdAndRoleId(final TestInfo testInfo) throws Exception {
        final SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(),
                "META-INF/jp/co/project/planets/earthly/schema/db/dao/UserRoleDao/selectByUserIdAndRoleId.sql",
                dialect);
        execute(sqlFile);
    }
