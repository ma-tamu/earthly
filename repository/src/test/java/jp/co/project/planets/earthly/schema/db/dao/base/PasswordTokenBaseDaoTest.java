 ...
 * 
 */
public class PasswordTokenBaseDaoTest {
    ...
    public void testSelectById(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/jp/co/project/planets/earthly/schema/db/dao/base/PasswordTokenBaseDao/selectById.sql", dialect);
        execute(sqlFile);
    }
