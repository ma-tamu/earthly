...
public class CompanySuggestRestController {
    ...
    public ResponseEntity<CompanyResponse> searchCompanies(
        @RequestParam("keyword") final Optional<String> keywordOptional,
        @AuthenticationPrincipal final EarthlyUserInfoDto userInfoDto) {
        final var companyList = suggestService.searchAccessibleCompanyByUserId(keywordOptional, userInfoDto.account());
