...
public record NoticeEditForm(String title, String body,
    ...
    public static Validator<NoticeEditForm> validator = ValidatorBuilder.<NoticeEditForm> of()
            .constraint(NoticeEditForm::title, "title",
            ...
            .constraint(NoticeEditForm::body, "body",
                    c -> c.notBlank().message("jakarta.validation.constraints.NotBlank.message")
                            .greaterThanOrEqual(1).message("validate.greater.than.or.equal")
                            .lessThanOrEqual(50).message("validate.less.than.or.equal"))
            .constraint(NoticeEditForm::startAt, "startAt",
            ...
            .constraint(NoticeEditForm::emphasis, "emphasis",
                    c -> c.notNull().message("jakarta.validation.constraints.NotBlank.message"))
            .build();

    public NoticeEditDto toDto() {
        return new NoticeEditDto(title, body, startAt, endAt, emphasis);
    }
}
